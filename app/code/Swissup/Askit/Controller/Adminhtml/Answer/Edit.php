...
class Edit extends \Swissup\Askit\Controller\Adminhtml\Message\AbstractEdit
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            $answer = $this->messageRepository->getById($id);
            if (!$answer->getId() || !$answer->getParentId()) {
        ...
        $title = $this->getShortenedText($answer->getText());
        $resultPage->setActiveMenu('Swissup_Askit::message_save')
