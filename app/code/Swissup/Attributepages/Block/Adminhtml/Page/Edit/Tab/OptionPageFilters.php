...
class OptionPageFilters extends AbstractTab implements TabInterface
{
    /**
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'attributepages_page_form')
    {
        ...
        $newChildUrl = $this->getUrl(
            'attributepages/page/newConditionHtml/form/' . $conditionsFieldSetId,
        ...
        $fieldset = $form->addFieldset($fieldsetId, [
                'legend' => __('Additional Product Collection Filters')
            ])
