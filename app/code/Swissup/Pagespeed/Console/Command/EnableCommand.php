...
class EnableCommand extends \Symfony\Component\Console\Command\Command
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->setName('swissup:pagespeed:enable')
            ->setDescription('Fast enable.')
            ->setDefinition([
                new InputOption(
